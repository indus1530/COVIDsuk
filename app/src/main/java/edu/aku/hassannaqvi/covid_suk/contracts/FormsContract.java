package edu.aku.hassannaqvi.covid_suk.contracts;
...
public class FormsContract {
    ...
    public static final String CONTENT_AUTHORITY = "edu.aku.hassannaqvi.covid_suk";
    public static final String PATH_FORMS = "forms";
    private final String projectName = "covid_suk";
    private String _ID = "";
    private String _UID = "";
